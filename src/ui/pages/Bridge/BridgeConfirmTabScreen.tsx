  ...
  const depositDetailItems = (
    <>
        ...
        <DetailRow
          ...
          value={
            openEditId !== 'edit_sat' ? (
              ...
              <div className={`w-full rounded-lg border ${'border-[#94E360] '} px-3 py-1 h-[42px]`}>
                <Input
                  onChange={(e) => {
      ...
      <DetailRow
        ...
        tooltip={
          'For peg-in, fees will be deducted from your Bitcoin balance; for peg-out, fees will be deducted from your Bitway balance.'
        }></DetailRow>
      ...
      <DetailRow
        ...
        tooltip={
          'Please note that the sBTC tokens you receive on the Bitway are not native BTC from the Bitcoin network. Instead, they are representations of BTC issued to you on the Bitway.'
        }></DetailRow>
    </>
  );
              ...
              <Column relative classname="bg-[#F0B622] p-3 px-2 bg-opacity-30 " rounded>
                <div className="flex items-start gap-1">
                  ...
                  <div className="font-semibold text-sm text-[#F0B622]">
                    {!isDeposit
                      ? ' Your sBTC tokens on the Bitway will be burnt'
