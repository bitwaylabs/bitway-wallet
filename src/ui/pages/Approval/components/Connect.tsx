...
import BitwayWallet from '@/ui/assets/icons/bitway_wallet.svg';
          ...
          {selected && (
            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
              <g filter="url(#filter0_i_863_3849)">
                <rect x="0.171875" width="20" height="20" rx="10" fill="#94E360" />
              </g>
              <path
      ...
      <Layout
        ...
        <Content>
          <Column>
            ...
            <Text text="Your access to this page has been restricted by Bitway Wallet as it might be unsafe." mt="md" />
          </Column>
        </Content>
