      ...
      {connected && (
        <div className={' gap-[4px] flex items-center cursor-pointer'} style={{}}>
          ...
          <div
            ...
            &nbsp;
            <div
              className={'text-[#94E360] text-[14px] hover:text-[#F7931A]'}
              onClick={() => {
                dispatch(
                  SwapActions.update({
                    swapPair: {
        ...
        <Content classname={'hide-scrollbar'}>
          ...
          <Column
            ...
            <div className="flex justify-between mt-[16px]">
              ...
              <div
                className="w-[108px] flex items-center justify-center rounded-[24px] border-[1px] border-[#94E3601A] bg-[#94E3604D] hover:bg-[#94E3601A] h-[30px] cursor-pointer"
                onClick={showModal}>
