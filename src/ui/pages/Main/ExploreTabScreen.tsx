...
export default function ExploreTabScreen() {
  ...
  return (
    <Layout>
      ...
      <Content>
        <div
          className={`mt-[16px] w-full border-[1px] border-solid px-[10px] flex items-center rounded-[10px] bg-[#17171C] relative gap-[8px] !min-h-[40px] ${
        ...
        <div className={`${searchTerm ? '' : '!hidden'} flex flex-col gap-[16px] mt-[16px]`}>
          <div className="flex  gap-[16px] mb-[10px] items-center">
            ...
            <div className=" relative  flex flex-col justify-center gap-[2px] flex-1">
              ...
              <div className={'font-[300] text-[12px] text-[#ffffff]/30'}>Dashboard for Bitway</div>
        ...
        <div className={!searchTerm ? '' : '!hidden'}>
          <Swiper
            ...
            className="mySwiper">
            <SwiperSlide>
              <img className={'w-full h-[98px] mt-[6px]'} src={''} alt={'banner'} />
            </SwiperSlide>
            <SwiperSlide>
              <img className={'w-full h-[98px] mt-[6px]'} src={''} alt={'banner2'} />
            </SwiperSlide>
          </Swiper>
          <div className="">
            ...
            <div className="flex gap-[16px] ">
              <div
                ...
                <div className="w-[56px] h-[56px] bg-[#030303] rounded-[16px] flex items-center justify-center border-[#94E360] border-[0.5px] group-hover:border-[#F7931A] ">
          ...
          <div className="">
            ...
            <div className="flex flex-col gap-[16px] ">
              <div
                ...
                <div className="w-[60px] h-[60px] bg-[#030303] rounded-[16px] flex items-center justify-center border-[#94E360] border-[0.5px] group-hover:border-[#F7931A] cursor-pointer">
                  <img className={'w-[30px] h-[30px]'} src="/images/icons/search/icon-station.png" alt="station" />
                </div>
