          ...
          <div className="flex-1 flex items-center justify-between text-white font-bold p-[5px] rounded-[16px] text-[14px] border border-solid border-[#ffffff1a] h-[50px] bg-black">
            {['0.25', '0.5', '1', ''].map((item, index) => {
              if (!item && index === 3) {
                return (
                  <div
                    className="w-[80px] flex items-center border border-solid border-[#848E9C] rounded-[100px] px-3 font-semibold bg-black focus-within:!border-[#94E360] transition-colors duration-300"
                    key={index}>
                    <input
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '100px',
                    fontWeight: 600,
                    background: item === slippage ? '#94E360' : '#1E1E1F',
