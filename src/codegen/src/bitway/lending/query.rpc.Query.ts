...
export interface Query {
  ...
  loansByOracle(request: QueryLoansByOracleRequest): Promise<QueryLoansByOracleResponse>;
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.loansByOracle = this.loansByOracle.bind(this);
  ...
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new BinaryReader(data)));
  }
  pool(request: QueryPoolRequest): Promise<QueryPoolResponse> {
    const data = QueryPoolRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.lending.Query", "Pool", data);
  ...
  pools(request: QueryPoolsRequest = {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Pools", data);
  ...
  poolExchangeRate(request: QueryPoolExchangeRateRequest): Promise<QueryPoolExchangeRateResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "PoolExchangeRate", data);
  ...
  collateralAddress(request: QueryCollateralAddressRequest): Promise<QueryCollateralAddressResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "CollateralAddress", data);
  ...
  liquidationPrice(request: QueryLiquidationPriceRequest): Promise<QueryLiquidationPriceResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "LiquidationPrice", data);
  ...
  dlcEventCount(request: QueryDlcEventCountRequest = {}): Promise<QueryDlcEventCountResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "DlcEventCount", data);
  ...
  loan(request: QueryLoanRequest): Promise<QueryLoanResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Loan", data);
  ...
  loans(request: QueryLoansRequest): Promise<QueryLoansResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Loans", data);
  ...
  loansByAddress(request: QueryLoansByAddressRequest): Promise<QueryLoansByAddressResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "LoansByAddress", data);
    return promise.then(data => QueryLoansByAddressResponse.decode(new BinaryReader(data)));
  }
  loansByOracle(request: QueryLoansByOracleRequest): Promise<QueryLoansByOracleResponse> {
    const data = QueryLoansByOracleRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.lending.Query", "LoansByOracle", data);
    return promise.then(data => QueryLoansByOracleResponse.decode(new BinaryReader(data)));
  }
  loanCetInfos(request: QueryLoanCetInfosRequest): Promise<QueryLoanCetInfosResponse> {
    const data = QueryLoanCetInfosRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.lending.Query", "LoanCetInfos", data);
  ...
  loanDlcMeta(request: QueryLoanDlcMetaRequest): Promise<QueryLoanDlcMetaResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "LoanDlcMeta", data);
  ...
  loanAuthorization(request: QueryLoanAuthorizationRequest): Promise<QueryLoanAuthorizationResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "LoanAuthorization", data);
  ...
  loanDeposits(request: QueryLoanDepositsRequest): Promise<QueryLoanDepositsResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "LoanDeposits", data);
  ...
  redemption(request: QueryRedemptionRequest): Promise<QueryRedemptionResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Redemption", data);
  ...
  repayment(request: QueryRepaymentRequest): Promise<QueryRepaymentResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Repayment", data);
  ...
  currentInterest(request: QueryCurrentInterestRequest): Promise<QueryCurrentInterestResponse> {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "CurrentInterest", data);
  ...
  referrers(request: QueryReferrersRequest = {
    ...
    const promise = this.rpc.request("bitway.lending.Query", "Referrers", data);
...
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    loansByOracle(request: QueryLoansByOracleRequest): Promise<QueryLoansByOracleResponse> {
      return queryService.loansByOracle(request);
    },
    loanCetInfos(request: QueryLoanCetInfosRequest): Promise<QueryLoanCetInfosResponse> {
