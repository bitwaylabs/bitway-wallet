...
export interface AssetMetadataProtoMsg {
  typeUrl: "/bitway.lending.AssetMetadata";
  value: Uint8Array;
}
/** Asset metadata */
...
export interface AssetMetadataAminoMsg {
  type: "/bitway.lending.AssetMetadata";
...
export interface PoolTrancheConfigProtoMsg {
  typeUrl: "/bitway.lending.PoolTrancheConfig";
  value: Uint8Array;
}
/** Pool tranche config */
...
export interface PoolTrancheConfigAminoMsg {
  type: "/bitway.lending.PoolTrancheConfig";
...
export interface PoolConfigProtoMsg {
  typeUrl: "/bitway.lending.PoolConfig";
  value: Uint8Array;
}
/** Pool config */
...
export interface PoolConfigAminoMsg {
  type: "/bitway.lending.PoolConfig";
...
export interface PoolTrancheProtoMsg {
  typeUrl: "/bitway.lending.PoolTranche";
  value: Uint8Array;
}
/** Pool tranche */
...
export interface PoolTrancheAminoMsg {
  type: "/bitway.lending.PoolTranche";
...
export interface LendingPoolProtoMsg {
  typeUrl: "/bitway.lending.LendingPool";
  value: Uint8Array;
}
...
export interface LendingPoolAminoMsg {
  type: "/bitway.lending.LendingPool";
...
export interface AuthorizationProtoMsg {
  typeUrl: "/bitway.lending.Authorization";
  value: Uint8Array;
}
/** Authorization with deposit txs for cets */
...
export interface AuthorizationAminoMsg {
  type: "/bitway.lending.Authorization";
...
export interface ReferrerProtoMsg {
  typeUrl: "/bitway.lending.Referrer";
  value: Uint8Array;
}
/** Referrer defines the referrer */
...
export interface LeafScriptProtoMsg {
  typeUrl: "/bitway.lending.LeafScript";
  value: Uint8Array;
}
/** LeafScript defines the tap leaf script */
...
export interface LeafScriptAminoMsg {
  type: "/bitway.lending.LeafScript";
...
export interface CetInfoProtoMsg {
  typeUrl: "/bitway.lending.CetInfo";
  value: Uint8Array;
}
...
export interface LiquidationCetProtoMsg {
  typeUrl: "/bitway.lending.LiquidationCet";
  value: Uint8Array;
}
...
export interface LiquidationCetAminoMsg {
  type: "/bitway.lending.LiquidationCet";
...
export interface RepaymentCetProtoMsg {
  typeUrl: "/bitway.lending.RepaymentCet";
  value: Uint8Array;
}
...
export interface RepaymentCetAminoMsg {
  type: "/bitway.lending.RepaymentCet";
...
export interface DLCMetaProtoMsg {
  typeUrl: "/bitway.lending.DLCMeta";
  value: Uint8Array;
}
...
export interface DepositLogProtoMsg {
  typeUrl: "/bitway.lending.DepositLog";
  value: Uint8Array;
}
...
export interface DepositLogAminoMsg {
  type: "/bitway.lending.DepositLog";
...
export interface RepaymentProtoMsg {
  typeUrl: "/bitway.lending.Repayment";
  value: Uint8Array;
}
...
export interface RedemptionProtoMsg {
  typeUrl: "/bitway.lending.Redemption";
  value: Uint8Array;
}
...
export interface RedemptionAminoMsg {
  type: "/bitway.lending.Redemption";
...
export const PoolTrancheConfig = {
  ...
  encode(message: PoolTrancheConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.borrowApr !== "") {
      writer.uint32(18).string(Decimal.fromUserInput(message.borrowApr, 18).atomics);
    }
    return writer;
  },
...
export const PoolConfig = {
  ...
  encode(message: PoolConfig, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.originationFeeFactor !== "") {
      writer.uint32(74).string(Decimal.fromUserInput(message.originationFeeFactor, 18).atomics);
    }
    if (message.reserveFactor !== "") {
      writer.uint32(82).string(Decimal.fromUserInput(message.reserveFactor, 18).atomics);
    }
    if (message.maxLtv !== "") {
      writer.uint32(90).string(Decimal.fromUserInput(message.maxLtv, 18).atomics);
    }
    if (message.liquidationThreshold !== "") {
      writer.uint32(98).string(Decimal.fromUserInput(message.liquidationThreshold, 18).atomics);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          break;
        case 9:
          message.originationFeeFactor = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 10:
          message.reserveFactor = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 11:
          message.maxLtv = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        case 12:
  ...
  fromPartial(object: Partial<PoolConfig>): PoolConfig {
    ...
    message.originationFeeFactor = object.originationFeeFactor ?? "";
  ...
  toAmino(message: PoolConfig): PoolConfigAmino {
    ...
    obj.origination_fee_factor = message.originationFeeFactor === "" ? undefined : message.originationFeeFactor;
    obj.reserve_factor = message.reserveFactor === "" ? undefined : message.reserveFactor;
    obj.max_ltv = message.maxLtv === "" ? undefined : message.maxLtv;
...
export const Loan = {
  ...
  encode(message: Loan, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.borrowApr !== "") {
      writer.uint32(122).string(Decimal.fromUserInput(message.borrowApr, 18).atomics);
    }
...
export const CetInfo = {
  ...
  encode(message: CetInfo, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.sighashType !== 0) {
      writer.uint32(40).uint32(message.sighashType);
    }
    return writer;
  },
  ...
  fromAmino(object: CetInfoAmino): CetInfo {
    ...
    if (object.sighash_type !== undefined && object.sighash_type !== null) {
      message.sighashType = object.sighash_type;
    }
    return message;
  },
  toAmino(message: CetInfo): CetInfoAmino {
    ...
    obj.sighash_type = message.sighashType === 0 ? undefined : message.sighashType;
    return obj;
  },
