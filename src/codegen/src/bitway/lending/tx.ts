...
export interface MsgCreatePoolAminoMsg {
  type: "/bitway.lending.MsgCreatePool";
...
export interface MsgUpdatePoolConfigAminoMsg {
  type: "/bitway.lending.MsgUpdatePoolConfig";
...
export interface MsgAddLiquidityAminoMsg {
  type: "/bitway.lending.MsgAddLiquidity";
...
export interface MsgRemoveLiquidityAminoMsg {
  type: "/bitway.lending.MsgRemoveLiquidity";
...
export interface MsgSubmitCetsAminoMsg {
  type: "/bitway.lending.MsgSubmitCets";
...
export interface MsgSubmitDepositTransactionAminoMsg {
  type: "/bitway.lending.MsgSubmitDepositTransaction";
...
export interface MsgRegisterReferrerAminoMsg {
  type: "/bitway.lending.MsgRegisterReferrer";
...
export interface MsgUpdateReferrerAminoMsg {
  type: "/bitway.lending.MsgUpdateReferrer";
...
export interface MsgUpdateParamsAminoMsg {
  type: "/bitway.lending.MsgUpdateParams";
...
export interface MsgUpdateParamsResponseProtoMsg {
  typeUrl: "/bitway.lending.MsgUpdateParamsResponse";
  value: Uint8Array;
}
/**
 * MsgUpdateParamsResponse defines the Msg/UpdateParams response type.
...
export interface MsgUpdateParamsResponseAminoMsg {
  type: "/bitway.lending.MsgUpdateParamsResponse";
