...
export interface AssetMetadataProtoMsg {
  typeUrl: "/bitway.liquidation.AssetMetadata";
  value: Uint8Array;
}
...
export interface AssetMetadataAminoMsg {
  type: "/bitway.liquidation.AssetMetadata";
...
export interface LiquidationProtoMsg {
  typeUrl: "/bitway.liquidation.Liquidation";
  value: Uint8Array;
}
...
export interface LiquidationAminoMsg {
  type: "/bitway.liquidation.Liquidation";
...
export interface LiquidationRecordProtoMsg {
  typeUrl: "/bitway.liquidation.LiquidationRecord";
  value: Uint8Array;
}
...
export interface LiquidationRecordAminoMsg {
  type: "/bitway.liquidation.LiquidationRecord";
