...
export interface MsgLiquidateAminoMsg {
  type: "/bitway.liquidation.MsgLiquidate";
...
export interface MsgLiquidateResponseProtoMsg {
  typeUrl: "/bitway.liquidation.MsgLiquidateResponse";
  value: Uint8Array;
}
/** MsgLiquidateResponse defines the Msg/Liquidate response type. */
export interface MsgLiquidateResponseAmino {}
export interface MsgLiquidateResponseAminoMsg {
  type: "/bitway.liquidation.MsgLiquidateResponse";
...
export interface MsgUpdateParamsAminoMsg {
  type: "/bitway.liquidation.MsgUpdateParams";
...
export interface MsgUpdateParamsResponseProtoMsg {
  typeUrl: "/bitway.liquidation.MsgUpdateParamsResponse";
  value: Uint8Array;
}
/**
 * MsgUpdateParamsResponse defines the Msg/UpdateParams response type.
...
export interface MsgUpdateParamsResponseAminoMsg {
  type: "/bitway.liquidation.MsgUpdateParamsResponse";
