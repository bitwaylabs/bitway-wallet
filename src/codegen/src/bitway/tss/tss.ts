...
export interface DKGCompletionProtoMsg {
  typeUrl: "/bitway.tss.DKGCompletion";
  value: Uint8Array;
}
/** DKG Completion */
...
export interface SigningOptionsProtoMsg {
  typeUrl: "/bitway.tss.SigningOptions";
  value: Uint8Array;
}
/** Signing Options */
...
export interface SigningOptionsAminoMsg {
  type: "/bitway.tss.SigningOptions";
...
export interface SigningRequestProtoMsg {
  typeUrl: "/bitway.tss.SigningRequest";
  value: Uint8Array;
}
/** Signing Request */
...
export interface SigningRequestAminoMsg {
  type: "/bitway.tss.SigningRequest";
...
export interface RefreshingRequestProtoMsg {
  typeUrl: "/bitway.tss.RefreshingRequest";
  value: Uint8Array;
}
/** Refreshing Request */
...
export interface RefreshingRequestAminoMsg {
  type: "/bitway.tss.RefreshingRequest";
...
export interface RefreshingCompletionProtoMsg {
  typeUrl: "/bitway.tss.RefreshingCompletion";
  value: Uint8Array;
}
/** Refreshing Completion */
...
export interface RefreshingCompletionAminoMsg {
  type: "/bitway.tss.RefreshingCompletion";
