...
export interface Query {
  ...
  estimatedReward(request: QueryEstimatedRewardRequest): Promise<QueryEstimatedRewardResponse>;
}
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.estimatedReward = this.estimatedReward.bind(this);
  }
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.farming.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new BinaryReader(data)));
  }
  staking(request: QueryStakingRequest): Promise<QueryStakingResponse> {
    const data = QueryStakingRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.farming.Query", "Staking", data);
  ...
  stakings(request: QueryStakingsRequest): Promise<QueryStakingsResponse> {
    ...
    const promise = this.rpc.request("bitway.farming.Query", "Stakings", data);
  ...
  stakingsByAddress(request: QueryStakingsByAddressRequest): Promise<QueryStakingsByAddressResponse> {
    ...
    const promise = this.rpc.request("bitway.farming.Query", "StakingsByAddress", data);
  ...
  totalStaking(request: QueryTotalStakingRequest): Promise<QueryTotalStakingResponse> {
    ...
    const promise = this.rpc.request("bitway.farming.Query", "TotalStaking", data);
    return promise.then(data => QueryTotalStakingResponse.decode(new BinaryReader(data)));
  }
  currentEpoch(request: QueryCurrentEpochRequest = {}): Promise<QueryCurrentEpochResponse> {
    const data = QueryCurrentEpochRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.farming.Query", "CurrentEpoch", data);
  ...
  rewards(request: QueryRewardsRequest): Promise<QueryRewardsResponse> {
    ...
    const promise = this.rpc.request("bitway.farming.Query", "Rewards", data);
  ...
  pendingReward(request: QueryPendingRewardRequest): Promise<QueryPendingRewardResponse> {
    ...
    const promise = this.rpc.request("bitway.farming.Query", "PendingReward", data);
  ...
  pendingRewardByAddress(request: QueryPendingRewardByAddressRequest): Promise<QueryPendingRewardByAddressResponse> {
    ...
    const promise = this.rpc.request("bitway.farming.Query", "PendingRewardByAddress", data);
    return promise.then(data => QueryPendingRewardByAddressResponse.decode(new BinaryReader(data)));
  }
  estimatedReward(request: QueryEstimatedRewardRequest): Promise<QueryEstimatedRewardResponse> {
    const data = QueryEstimatedRewardRequest.encode(request).finish();
    const promise = this.rpc.request("bitway.farming.Query", "EstimatedReward", data);
    return promise.then(data => QueryEstimatedRewardResponse.decode(new BinaryReader(data)));
  }
}
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    estimatedReward(request: QueryEstimatedRewardRequest): Promise<QueryEstimatedRewardResponse> {
      return queryService.estimatedReward(request);
    }
  };
};