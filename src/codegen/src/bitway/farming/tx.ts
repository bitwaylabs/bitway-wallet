...
export interface MsgUnstakeAminoMsg {
  type: "/bitway.farming.MsgUnstake";
...
export interface MsgClaimAllAminoMsg {
  type: "/bitway.farming.MsgClaimAll";
...
export interface MsgUpdateParamsAminoMsg {
  type: "/bitway.farming.MsgUpdateParams";
...
export interface MsgUpdateParamsResponseProtoMsg {
  typeUrl: "/bitway.farming.MsgUpdateParamsResponse";
  value: Uint8Array;
}
/**
 * MsgUpdateParamsResponse defines the Msg/UpdateParams response type.
...
export interface MsgUpdateParamsResponseAminoMsg {
  type: "/bitway.farming.MsgUpdateParamsResponse";
